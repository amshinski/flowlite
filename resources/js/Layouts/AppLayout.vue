...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
                                        ...
                                        <span v-else class="inline-flex rounded-md">
                                            <button
                                                ...
                                                class="inline-flex items-center px-3 py-2 border border-transparent
                                                    ...
                                                    dark:hover:text-gray-300 focus:outline-none focus:bg-gray-50
                                                    dark:focus:bg-gray-700 active:bg-gray-50 dark:active:bg-gray-700
            ...
            <main class="relative overflow-hidden min-h-[calc(100vh-4rem)]">
                <img
                    id="background"
                    class="absolute -left-20 top-0 max-w-[877px] object-cover object-center opacity-50 z-0"
